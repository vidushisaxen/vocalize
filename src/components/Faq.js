...
function Faq() {
  return (
    <> 
      <section className="w-screen  flex justify-around mobile:flex-col  mobile:ml-[5vw] mobile:w-[95%] mobile:mr-[5vw] mobile:h-[100%] tablet:flex-col tablet:ml-[5vw] tablet:w-[95%] table:mr-[5vw] tablet:h-[100%]">
        <div className="flex flex-col w-[24%] mobile:w-[95%] tablet:w-[95%] ">
          ...
          <div className="mt-[1vw] text-[1.2vw] text-[#88038F] overflow-hidden w-fit mobile:text-[4vw] tablet:text-[3vw]">
